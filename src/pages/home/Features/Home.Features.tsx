...
const HomeFeatures: React.FC = () => {
  ...
  useGSAP(() => {
    gsap
      ...
      .to(containerRef.current, { y: 120 })
      .to(containerRef.current, { filter: 'blur(5px)' }, 0.3);
  });

  return (
    <div className="w-screen  overflow-hidden lg:py-36 py-10 lg:px-36 px-10 bg-white/97">
      <div
        ref={containerRef}
        className="flex lg:flex-row flex-col gap-20 justify-between items-center"
      >
        <HomeFeaturesItems
          src={csTrust}
