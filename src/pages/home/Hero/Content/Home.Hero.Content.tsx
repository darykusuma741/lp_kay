  ...
  return (
    <div className="absolute pb-48 hero-container-content w-screen h-screen flex justify-center items-center m2:px-37.5 md:px-20 px-10 gap-20">
      <div className="flex flex-col gap-6 sm:w-140 w-full hero-container-content-1">
        <h1 className="text-white font-ibm font-normal text-[4rem]">
          Founder of KAY Digital Studio
        </h1>
        <p className="text-stone text-[1rem] italic">
        ...
        <div>
          <button className="flex items-center group text-[0.9rem] text-stone transition-colors hover:text-midnight gap-5 btn-gradient cursor-pointer font-normal px-5 py-2 rounded-full">
      ...
      <div className="w-90 items-center hero-container-content-2">
        <img src={photo} />
      </div>
    </div>
  );
